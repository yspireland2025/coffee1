...
import {
  ...
  Phone, RefreshCw, Truck, Edit2, X, Save, Plus, Trash2, Settings
} from 'lucide-react';
...
export default function PackManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'contents' && <PackContentsManager />}
    </div>
  );

  function PackContentsManager() {
    ...
    const handleAddItem = async () => {
      ...
      await addPackContent(selectedPackType, newItemName, newQuantity);
      setNewItemName('');
      setNewQuantity(1);
    };
    ...
    const handleUpdateItem = async (id: string) => {
      ...
      await updatePackContent(id, editItemName, editQuantity);
      setEditingItem(null);
      setEditItemName('');
      setEditQuantity(1);
    };
                        ...
                        <div className="flex items-center justify-end space-x-2">
                          {editingItem === item.id ? (
                            ...
                            <>
                              ...
                              <button
                                onClick={() => deletePackContent(item.id)}
